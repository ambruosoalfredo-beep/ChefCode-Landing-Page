            ...
            <header className="bg-slate-900 sticky top-0 z-50">
                <div className="container mx-auto px-4 md:px-8 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        >
                            <ArrowLeft size={20} />
                            <span>{t('privacyPolicy.header.backToHome')}</span>
                        </Link>
                    </div>
                </div>
            </header>
            ...
            <section className="bg-slate-900 text-white py-20">
                <div className="container mx-auto px-4 md:px-8 text-center">
                    <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md px-6 py-3 rounded-full mb-6">
                        ...
                        <span className="font-bold text-sm uppercase tracking-wider">{t('privacyPolicy.hero.tag')}</span>
                    </div>
                    <h1 className="text-4xl md:text-6xl font-black mb-4">{t('privacyPolicy.hero.title')}</h1>
                    <p className="text-slate-300 text-lg max-w-2xl mx-auto">
                        {t('privacyPolicy.hero.desc')}
                    </p>
                    <p className="text-slate-500 text-sm mt-4">{t('privacyPolicy.hero.lastUpdated')}</p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-4xl">
                    ...
                    <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 border-2 border-orange-200 rounded-3xl p-8 mb-12">
                        <h2 className="text-2xl font-black text-slate-900 mb-4 flex items-center gap-3">
                            ...
                            {t('privacyPolicy.summary.title')}
                        </h2>
                        <ul className="space-y-3 text-slate-700">
                            {t('privacyPolicy.summary.items', { returnObjects: true }).map((item, i) => (
                    ...
                    <div className="grid gap-8">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-6 flex flex-col md:flex-row items-center text-center md:text-left gap-3">
                                ...
                                {t('privacyPolicy.s1.title')}
                            </h2>
                            <div className="space-y-4 text-slate-600 leading-relaxed">
                                <p>{t('privacyPolicy.s1.details')}</p>
                                <ul className="grid sm:grid-cols-2 gap-3 mt-2">
                                    {t('privacyPolicy.s1.items', { returnObjects: true }).map((item, i) => (
                                        <li key={i} className="flex items-center gap-2 bg-slate-50 p-3 rounded-lg border border-slate-100">
                                ...
                                <div className="mt-6 p-5 bg-slate-50 rounded-xl border-l-4 border-slate-900">
                                    <div className="grid md:grid-cols-2 gap-6 text-sm">
                                        <div>
                                            <span className="block font-bold text-slate-900 mb-1">{t('privacyPolicy.s1.website')}</span>
                                        ...
                                        <div>
                                            <span className="block font-bold text-slate-900 mb-1">{t('privacyPolicy.s1.contact')}</span>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-6 flex flex-col md:flex-row items-center text-center md:text-left gap-3">
                                ...
                                {t('privacyPolicy.s2.title')}
                            </h2>
                            <p className="text-slate-600 mb-6">{t('privacyPolicy.s2.desc')}</p>

                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="bg-orange-50/50 border border-orange-100 rounded-xl p-6">
                                    <h3 className="font-bold text-slate-900 mb-4 flex items-center gap-2">
                                        <div className="w-8 h-1 bg-orange-500 rounded-full"></div>
                                        {t('privacyPolicy.s2.personal')}
                                    </h3>
                                    <ul className="space-y-3">
                                        {t('privacyPolicy.s2.personalItems', { returnObjects: true }).map((item, i) => (
                                ...
                                <div className="bg-slate-50 border border-slate-100 rounded-xl p-6">
                                    <h3 className="font-bold text-slate-900 mb-4 flex items-center gap-2">
                                        ...
                                        {t('privacyPolicy.s2.technical')}
                                    </h3>
                                    <ul className="space-y-3">
                                        {t('privacyPolicy.s2.technicalItems', { returnObjects: true }).map((item, i) => (
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-6 flex flex-col md:flex-row items-center text-center md:text-left gap-3">
                                ...
                                {t('privacyPolicy.s3.title')}
                            </h2>
                            <p className="text-slate-600 mb-6">{t('privacyPolicy.s3.desc')}</p>
                            <div className="grid sm:grid-cols-2 gap-4 mb-6">
                                {t('privacyPolicy.s3.items', { returnObjects: true }).map((purpose, i) => (
                            ...
                            <p className="text-slate-500 text-sm italic border-t border-slate-100 pt-4">{t('privacyPolicy.s3.note')}</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-6 flex flex-col md:flex-row items-center text-center md:text-left gap-3">
                                ...
                                {t('privacyPolicy.s4.title')}
                            </h2>
                            <p className="text-slate-600 mb-4">{t('privacyPolicy.s4.desc')}</p>
                            <div className="flex flex-wrap gap-3">
                                {t('privacyPolicy.s4.items', { returnObjects: true }).map((item, i) => (
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-6 flex flex-col md:flex-row items-center text-center md:text-left gap-3">
                                ...
                                {t('privacyPolicy.s5.title')}
                            </h2>
                            <ul className="grid sm:grid-cols-3 gap-4">
                                <li className="bg-slate-900 text-white p-5 rounded-xl flex flex-col items-center text-center gap-3">
                                    <Shield className="text-emerald-400" />
                                    <span className="text-sm font-medium">{t('privacyPolicy.s5.items', { returnObjects: true })[0]}</span>
                                </li>
                                <li className="bg-slate-900 text-white p-5 rounded-xl flex flex-col items-center text-center gap-3">
                                    <Lock className="text-orange-400" />
                                    <span className="text-sm font-medium">{t('privacyPolicy.s5.items', { returnObjects: true })[1]}</span>
                                </li>
                                <li className="bg-slate-900 text-white p-5 rounded-xl flex flex-col items-center text-center gap-3">
                                    <Eye className="text-blue-400" />
                                    <span className="text-sm font-medium">{t('privacyPolicy.s5.items', { returnObjects: true })[2]}</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-6 flex flex-col md:flex-row items-center text-center md:text-left gap-3">
                                ...
                                {t('privacyPolicy.s6.title')}
                            </h2>
                            <p className="text-lg text-slate-800 mb-6">{t('privacyPolicy.s6.notSell')}</p>
                            <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                                <p className="text-slate-700 font-medium mb-4">{t('privacyPolicy.s6.onlyShare')}</p>
                                <div className="space-y-4">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <strong className="block text-slate-900 text-sm">{t('privacyPolicy.s6.services.title')}</strong>
                                            <span className="text-slate-600 text-sm">{t('privacyPolicy.s6.services.desc')}</span>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        <div className="bg-white p-2 rounded-lg shadow-sm h-fit border border-slate-100"><Lock size={18} className="text-slate-400" /></div>
                                        <div>
                                            <strong className="block text-slate-900 text-sm">{t('privacyPolicy.s6.legal.title')}</strong>
                                            <span className="text-slate-600 text-sm">{t('privacyPolicy.s6.legal.desc')}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-6 flex flex-col md:flex-row items-center text-center md:text-left gap-3">
                                ...
                                {t('privacyPolicy.s7.title')}
                            </h2>
                            <p className="text-slate-600 mb-6">{t('privacyPolicy.s7.desc')}</p>
                            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                {t('privacyPolicy.s7.items', { returnObjects: true }).map((right, i) => (
                            ...
                            <div className="flex items-center justify-center gap-2 text-slate-600 bg-slate-50 p-4 rounded-xl">
                                <span>{t('privacyPolicy.s7.contact')}</span>
                                <a href="mailto:chefcodeproject@gmail.com" className="text-orange-600 font-bold hover:underline">chefcodeproject@gmail.com</a>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-6 flex flex-col md:flex-row items-center text-center md:text-left gap-3">
                                ...
                                {t('privacyPolicy.s8.title')}
                            </h2>
                            <p className="text-slate-600 mb-4">{t('privacyPolicy.s8.desc')}</p>
                            <div className="bg-orange-50 border-l-4 border-orange-500 p-4 mb-6">
                                <p className="text-orange-900 font-medium">{t('privacyPolicy.s8.consent')}</p>
                            </div>
                            <div className="bg-slate-900 text-slate-300 rounded-xl p-6">
                                <h4 className="text-white font-bold mb-4 flex items-center gap-2"><Eye size={18} className="text-emerald-400" /> {t('privacyPolicy.s8.featuresTitle')}</h4>
                                <ul className="grid sm:grid-cols-3 gap-4 text-sm">
                                    {t('privacyPolicy.s8.features', { returnObjects: true }).map((feature, i) => (
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                            <h2 className="text-2xl font-black text-slate-900 mb-4 flex items-center gap-3">
                                ...
                                {t('privacyPolicy.s9.title')}
                            </h2>
                            <p className="text-slate-600">{t('privacyPolicy.s9.desc')}
                            </p>
                        </div>
                    ...
                    <div className="text-center mt-12">
                        <Link
                            to="/"
                            className="inline-flex items-center gap-2 bg-orange-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-orange-50 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
                        >
                            <ArrowLeft size={20} />
