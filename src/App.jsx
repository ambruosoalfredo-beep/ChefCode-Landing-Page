    ...
    <div className="min-h-screen bg-slate-50/50 font-sans text-slate-800 selection:bg-orange-100 selection:text-orange-900">
      ...
      <section className="relative pt-40 pb-32 md:pt-52 md:pb-48 overflow-hidden bg-slate-900 border-b border-slate-800">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/80 border border-slate-700 text-orange-400 text-sm font-bold mb-10 shadow-xl backdrop-blur-md hover:scale-105 transition-transform cursor-default">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.95] mb-10 text-white tracking-tighter">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center mb-20">
            ...
            <button onClick={scrollToDemo} className="bg-slate-800/50 border border-slate-700 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-slate-800 hover:border-orange-500/50 transition-all flex items-center gap-2 min-w-[240px] justify-center backdrop-blur-sm">
          ...
          <div className="border-t border-slate-800/60 pt-12 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            {[
              { val: "500+", label: "Trusted Kitchens", desc: "Across Europe & US", color: "text-emerald-400" },
            ...
            {[
              {
                ...
                title: "Scan & Capture",
                desc: "Snap invoices or say ingredients out loud. ChefCode logs everything instantly."
              },
              {
              ...
              <div key={idx} className="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-300 flex flex-col items-center text-center group">
      ...
      <section id="features" className="py-24 bg-slate-900 rounded-[3rem] mx-4 md:mx-8 my-8 relative overflow-hidden border border-slate-800 shadow-2xl">
              ...
              <div className="bg-slate-800/50 p-8 rounded-3xl border border-slate-700/50 backdrop-blur-sm">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3 text-slate-300">
                    ...
                    <span className="font-medium">Speak, type, or scan - ChefCode adapts to your workflow.</span>
                  </li>
                  <li className="flex items-start gap-3 text-slate-300">
                    <CheckCircle2 size={20} className="text-emerald-500 mt-0.5 shrink-0" />
                    <span className="font-medium">Works in dead-zones, basements, and walk-ins.</span>
                  </li>
                </ul>
              </div>
            </div>
                        ...
                        <div className="grid gap-2">
                          <div className="flex items-center justify-between bg-slate-50 p-3 rounded-xl border border-slate-100">
                            ...
                            <div className="text-right">
                              ...
                              <div className="font-bold text-emerald-600">+ 20 KG</div>
                            </div>
                          </div>
                          <div className="flex items-center justify-between bg-slate-50 p-3 rounded-xl border border-slate-100">
                            <div className="flex items-center gap-3">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="bg-slate-50 rounded-[2.5rem] p-10 hover:shadow-2xl transition-all duration-300 border border-slate-100 hover:border-orange-200 group relative overflow-hidden">
              ...
              <div className="bg-white rounded-2xl p-4 shadow-lg border border-slate-100 relative max-w-sm mx-auto transform rotate-1 group-hover:rotate-0 transition-transform">
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-10 shadow-2xl text-white relative overflow-hidden group">
              ...
              <p className="mt-8 text-orange-400 font-bold text-xs tracking-[0.2em] uppercase opacity-80">Tagline: Your menu finally tells the truth.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="w-full md:w-1/2 order-1 md:order-2">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-slate-800 font-medium">
                  ...
                  Smart prep lists & Batch production scaling
                </li>
                <li className="flex items-center gap-3 text-slate-800 font-medium">
                  <CheckCircle2 size={20} className="text-orange-500" />
                ...
                <li className="flex items-center gap-3 text-slate-800 font-medium">
                  <CheckCircle2 size={20} className="text-orange-500" />
                  Auto-shopping from stock and sales
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-20 text-white text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="max-w-3xl mx-auto relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-12">
                {['Temperature logs', 'Batch traceability', 'Daily checklists', 'Instant audit reports'].map((tag, i) => (
                  <span key={i} className="px-5 py-2.5 bg-white/5 border border-white/10 rounded-full text-sm font-bold text-slate-300 backdrop-blur-md hover:bg-white/10 transition-colors cursor-default">
                    {tag}
                  </span>
                ))}
              </div>
      ...
      <section id="dr-ai" className="py-24 bg-orange-50/50">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.05)] border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group relative overflow-hidden flex flex-col items-center text-center">
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.05)] border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group relative overflow-hidden flex flex-col items-center text-center">
              ...
              <p className="text-slate-500 leading-relaxed font-medium">Optimize menus based on profitability. Dr.AI knows which dishes make you the most money.</p>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="border-t border-slate-100 pt-16 text-center">
            <h3 className="text-xl font-bold mb-10 text-slate-400 uppercase tracking-widest">Integrates with your stack</h3>
            <div className="flex flex-wrap justify-center gap-4 md:gap-8">
              {['POS Systems', 'ERP Software', 'Accounting Tools', 'Supplier Portals'].map((logo, i) => (
                <div key={i} className="px-8 py-4 bg-slate-50 rounded-2xl font-bold text-slate-400 border border-slate-100 hover:border-orange-200 hover:text-orange-600 hover:bg-white hover:shadow-lg transition-all cursor-default">
                  {logo}
                </div>
              ))}
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div>
              <div className="flex items-center gap-2 mb-6 text-white">
                <ChefHat size={24} />
                <span className="font-extrabold text-xl tracking-tight">ChefCode</span>
              </div>
              <p className="mb-6 max-w-xs leading-relaxed font-medium text-slate-500">
                The invisible brain behind modern kitchens. Turning chaos into control since 2025.
              </p>
...
export default ChefCodeLanding;